...
import { ActionType, FileFlag } from './file';
...
export class BaseFileSystem extends FileSystem {
  static override readonly Name: string = this.name;
...
export class SynchronousFileSystem extends BaseFileSystem {
  ...
  public override async readlink(p: string, cred: Cred): Promise<string> {
