...
export class Promisify {
  private _deactivationPromise: null;
  private _deactivationTimeout: null;
  private _activationPromise: null;
  private _operations: Set<unknown>;
  private _initPromiseResolve: any;
  private _initPromise: any;
  private _backend: any;
  private _isShuttingDown: boolean;
  private _gracefulShutdownResolve: (value: unknown) => void;
