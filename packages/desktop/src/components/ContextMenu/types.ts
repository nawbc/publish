export type BuiltInOrString<T> = T | (string & object);
...
/**
 * Theme is appended to `react-contextmenu__theme--${given theme}`.
 *
 ...
 * - `.react-contextmenu__will-enter--${given animation}`
 * - `.react-contextmenu__will-leave--${given animation}`
 *
